...
export const AttachedImages = (props: {
   ...
   const sectionClass = `xl:w-[720px] pt-[135px] xl:pt-[84px] xl:pb-[305px] xl:relative ${props.class}`;

   return (
      <section className={sectionClass}>
         <div className="pb-[10px] mb-[10px] xl:mb-[20px] border-b-[1px] border-b-[#3A456213]">
