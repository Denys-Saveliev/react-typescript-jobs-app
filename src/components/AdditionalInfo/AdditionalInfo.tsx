...
export const AdditionalInfo = (props: {
   ...
   return (
      <section className="pt-[63px] xl:pt-[86px]">
         ...
         <h3 className="mb-[5px] font-normal text-[18px] text-[#38415d82] xl:text-[#3A4562] tracking-[-0.56px] leading-[1.33]">Employment type</h3>
         <div className="flex flex-wrap mb-[17px]">
            <EmploymentTypes types={props.types} />
         </div>
         <h3 className="mb-[7px] font-normal text-[18px] text-[#38415d82] xl:text-[#3A4562] tracking-[-0.56px] leading-[1.33]">Benefits</h3>
